...
export default class AccountProfile extends React.Component {
  ...
  loadData() {
    ...
    $.ajax({
      url: "http://profile-service-talent.azurewebsites.net/profile/profile/getTalentProfile",
      headers: {
  ...
  saveProfile() {
    var cookies = Cookies.get("talentAuthToken");
    $.ajax({
      url: "http://profile-service-talent.azurewebsites.net/profile/profile/updateTalentProfile",
      headers: {
        Authorization: "Bearer " + cookies,
        "Content-Type": "application/json",
      },
                  ...
                  <div className="ui grid">
                    ...
                    >
                      <PhotoUpload
                        ...
                        updateProfileData={this.updateWithoutSave}
                        savePhotoUrl="http://profile-service-talent.azurewebsites.net/profile/profile/updateProfilePhoto"
                      />
                    </FormItemWrapper>
                    {/*                    <FormItemWrapper
                                            title='Education'
